      ...
      <div className="flex-1 w-full flex flex-col items-center justify-center p-6 text-center mt-20 md:mt-32">
        ...
        >
          ...
          <motion.div 
            ...
            className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-xs font-medium tracking-widest text-violet-200 uppercase mb-8"
          >
            PoroBangla AI 2.0
          </motion.div>
          ...
          <motion.button
            ...
            className="group relative px-10 py-4 bg-white text-black font-semibold rounded-full text-lg shadow-[0_0_40px_-10px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.5)] transition-all duration-300"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="glass-card p-8 rounded-3xl text-left hover:bg-white/5 transition-colors duration-300"
              >
