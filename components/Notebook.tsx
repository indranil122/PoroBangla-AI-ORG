                ...
                components={{
                    ...
                    table: ({node, ...props}) => (
                        <div className="overflow-x-auto my-8 rounded-lg border border-secondary/20 shadow-sm print:shadow-none print:border print:border-black print:my-4 print:rounded-none">
                            <table className="min-w-full divide-y divide-secondary/20 bg-transparent print:divide-black" {...props} />
                        </div>
                    ),
                    ...
                    td: ({node, ...props}) => <td className="px-6 py-4 text-sm text-secondary leading-relaxed border-t border-secondary/10 align-top print:text-black print:px-3 print:py-2 print:border-t print:border-gray-300" {...props} />,
