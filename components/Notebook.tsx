...
const Notebook: React.FC<NotebookProps> = ({ content, language, title, settings = { fontSize: 'md', layout: 'standard' } }) => {
  ...
  return (
    ...
    >
      {/* The Paper Card */}
      <div id="printable-notebook" className="relative bg-zinc-50 rounded-lg shadow-2xl overflow-hidden min-h-[800px] print:shadow-none print:rounded-none print:bg-white print:overflow-visible">
